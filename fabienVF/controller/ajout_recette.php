...
$fichier = basename($_FILES['recette']['name']);
$taille_maxi = 100000;
$taille = filesize($_FILES['recette']['tmp_name']);
$extensions = array('.png', '.jpg', '.jpeg');
$extension = strrchr($_FILES['recette']['name'], '.'); 
...
if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
{
     ...
     if(move_uploaded_file($_FILES['recette']['tmp_name'], $dossier .$nouveauNom)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
     {
