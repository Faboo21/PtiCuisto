            ...
            for (var i = start; i < end; i++) {
                if (recipes[i]) {
                    var row = $('<a href="../../controller/detail.php?id=' + recipes[i]['REC_Id'] + '" class="text-decoration-none text-dark">' +
                        ...
                        '<a class="nav-link cursor-pointer" href="../../controller/accepterRefuser.php?id=' + recipes[i]['REC_Id'] + '&n=1" style="color:#000000;">Accepter</a>' +
                        '<a class="nav-link cursor-pointer" href="../../controller/accepterRefuser.php?id=' + recipes[i]['REC_Id'] + '&n=0" style="color:#000000;">Refuser</a>' +
