...
<div class="custom-container mt-3">
    ...
    <div class="row">
        ...
        <div class="col-md-5 border border-primary m-5"> <!-- Réduire la largeur à col-md-5 -->
            ...
            <ul class="list-group list-group-flush">
                ...
                if (is_array($recipes) && !empty($recipes)) {
                    foreach ($recipes as $row) {
                        ...
                        echo '<div class="col-md-4 col-12">'; // Pour que cela prenne toute la largeur sur mobile
                        // Ajoutez des classes responsives à l'image pour la redimensionner
                        echo '<img src="../../images/image_recette/' . $row['REC_Image'] . '" alt="Image_' . $row['REC_Titre'] . '" class="img-fluid">';
                        echo '</div>';
                        echo '<div class="col-md-8 col-12 texte">'; // Pour que cela prenne toute la largeur sur mobile
        ...
        <!-- Zone d'édito -->
        <div class="col-md-6 bg-primary p-4"> <!-- Réduire la largeur à col-md-6 -->
